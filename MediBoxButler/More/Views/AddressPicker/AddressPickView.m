...
-(void)_createView
{
    ...
    UIView *lineV = [[UIView alloc] initWithFrame:CGRectMake(0, navigationViewHeight - 1, kScreenWidth, 0.5)];
    ...
    _pickView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, navigationViewHeight, kScreenWidth, pickViewViewHeight + 18)];
